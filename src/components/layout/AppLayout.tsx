...
export const AppLayout: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-transparent text-base-content">
      ...
      />
      <footer className="footer bg-base-300/40 backdrop-blur-md text-base-content/70 py-2.5 px-4 border-t border-base-300/30 hidden md:flex justify-center items-center gap-4 text-xs shrink-0 select-none">
        <span>
