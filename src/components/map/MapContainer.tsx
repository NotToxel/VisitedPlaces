...
export const MapContainer: React.FC = () => {
  ...
  // Search/Highlight feature using static countries list
      ...
      <div className="map-controls-header">
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', overflowX: 'auto', maxWidth: '100%' }}>
          <div className="map-controls-group">
            ...
            <button 
              className={`glass-button ${activeMode === 'REVISIT' ? 'glass-button--primary' : ''}`}
              onClick={() => setActiveMode('REVISIT')}
              style={{ 
                borderColor: activeMode === 'REVISIT' ? 'var(--accent-revisit)' : 'transparent', 
                color: activeMode === 'REVISIT' ? 'var(--accent-revisit)' : '' 
              }}
            >
              Mark Revisit
            </button>
        ...
        <div className="map-controls-group">
          {(
            [
              ...
              ['AVOID', showAvoid, setShowAvoid, 'var(--color-avoid)']
            ] as const
            ...
            <button
              ...
              style={{ 
                ...
                borderColor: shown ? color : 'transparent', 
                color: shown ? color : 'var(--text-muted)', 
                whiteSpace: 'nowrap' 
              }}
            >
          ...
          <input 
            ...
            list="map-country-search-list"
            style={{ padding: '0.5rem', borderRadius: '4px', width: '200px', flexShrink: 0 }}
          />
          <datalist id="map-country-search-list">
            {COUNTRIES.map(c => (
