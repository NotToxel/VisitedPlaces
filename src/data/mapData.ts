// Global map markers for microstates and small entities.
// Overseas territories are now managed by src/data/territoriesRegistry.ts
...
export const MICROSTATES: MapMarker[] = [
  ...
  { id: 'CPV', name: 'Cape Verde', coordinates: [-23.0418, 16.0022], flagCode: 'cv' },
  { id: 'COM', name: 'Comoros', coordinates: [43.8722, -11.8750], flagCode: 'km' },
  { id: 'DMA', name: 'Dominica', coordinates: [-61.3710, 15.4150], flagCode: 'dm' },
  { id: 'KIR', name: 'Kiribati', coordinates: [172.9717, 1.4518], flagCode: 'ki' },
  { id: 'WSM', name: 'Samoa', coordinates: [-172.1046, -13.7590], flagCode: 'ws' },
  { id: 'STP', name: 'São Tomé and Príncipe', coordinates: [6.6131, 0.1864], flagCode: 'st' },
  { id: 'TON', name: 'Tonga', coordinates: [-175.1982, -21.1789], flagCode: 'to' },
